  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
      <div className={`${reverse ? 'md:order-2' : 'md:order-1'} `}>
        <div className={`flex flex-col justify-center ${reverse ? `sm:items-end` : `sm:items-start`} md:items-start`}>
          ...
          <p className={`text-lg mb-4 ${reverse ? 'sm:text-right md:text-left' : 'text-left md:text-left'}`}>{description}</p>
          {/* <p className={`text-lg mb-4 ${reverse ? 'sm:text-right' : 'text-left md:text-left'}`}>{description}</p> */}
        </div>
      </div>
